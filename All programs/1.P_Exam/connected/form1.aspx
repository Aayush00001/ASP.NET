...
<br />
    ...
    <asp:RadioButton ID="RadioButton2" runat="server" text="female" GroupName="a"/><br /><br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:connectedConnectionString %>" 
        SelectCommand="SELECT * FROM [data1]"></asp:SqlDataSource><br /><br />
